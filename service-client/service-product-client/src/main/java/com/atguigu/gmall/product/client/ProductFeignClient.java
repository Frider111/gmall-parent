...
import com.atguigu.gmall.product.client.impl.ProductFeignClientFallback;
...
public interface ProductFeignClient  {
    ...
    List<SpuSaleAttr> getSpuSaleAttrListCheckBySku(@PathVariable("skuId") Long skuId, @PathVariable("spuId") Long spuId)  throws Exception ;
